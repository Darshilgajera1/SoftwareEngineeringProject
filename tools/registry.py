...
class ToolRegistry:
    ...
    def query_unregistered_tools_by_description(self, description, agent_name, tool_path="./PoolofTools"):
        ...
        unregistered_tools = str(["'Description':" + tool.page_content + "," + str(tool.metadata) for tool in tools if tool.metadata["tool_name"] not in registed_tool_names])

        return unregistered_tools


def register_tool(tool_function, tool_filename, agent_name, tool_path="./PoolofTools"):
...
def query_unregistered_tools(description, agent_name, tool_path="./PoolofTools"):
...
class ToolDataStore:
    def __init__(self, tool_path="./PoolofTools"):
...
#     register_tool("image_downloader", "ImageDownloader.py", "agent1", tool_path="../PoolofTools")
#     print(query_unregistered_tools("Make dank memes", "agent1", tool_path="../PoolofTools"))
